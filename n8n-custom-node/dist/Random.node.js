        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                if (operation === 'generateRandomNumber') {
                    ...
                    if (min > max) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Minimum value cannot be greater than maximum value', { itemIndex: i });
                    }
                    ...
                    if (isNaN(randomNumber)) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Failed to parse random number from Random.org response', { itemIndex: i });
                    }
                    returnData.push({
                        json: {
                            randomNumber,
